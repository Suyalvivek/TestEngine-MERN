...
const About = () => {
  return (
    <section id="about" className="py-20 sm:py-32 bg-accent/50 dark:bg-accent/10">
          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Easy to Use Interface</h4>
                  <p className="text-muted-foreground">Intuitive design that requires no technical skills. Create quizzes in minutes, not hours.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Get started in under 5 minutes. No complex configurations or steep learning curves.</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-2">Focus on Learning</h4>
                  <p className="text-muted-foreground">Every feature is designed to enhance the learning experience, not distract from it.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-card rounded-xl shadow-lg p-8 border border-border">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold">TestEngine Stats</h4>
                    <p className="text-sm text-muted-foreground/75">Platform Overview</p>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="text-center p-4 bg-orange-50/50 dark:bg-orange-950/20 rounded-lg">
