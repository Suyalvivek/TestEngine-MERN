  ...
  return (
    <section id="features" className="py-20 sm:py-32 bg-background">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="group">
              <div className={`${feature.bgColor} dark:bg-${feature.color.split('-')[1]}-950/20 rounded-xl p-8 h-full border border-border hover:shadow-lg transition-shadow duration-300`}>
        ...
        {/* Quiz Demo Section */}
        <div className="mt-20 bg-accent/50 rounded-xl p-8 lg:p-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span>Create quizzes in under 5 minutes</span>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4">
                    <Check className="w-5 h-5 text-white" />
                  </div>
                  <span>Real-time scoring and analytics</span>
                </div>
                <div className="flex items-center">
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center mr-4">
                    <Check className="w-5 h-5 text-white" />
              ...
              <div className="bg-card rounded-xl shadow-lg p-6 border border-border">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold">Sample Quiz</h4>
                ...
                <div className="bg-accent/50 rounded-lg p-4 mb-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center p-2 bg-card rounded border-2 border-green-200">
                      <div className="w-3 h-3 bg-green-500 rounded-full mr-3"></div>
                      <span className="text-xs">JavaScript</span>
                    </div>
                    <div className="flex items-center p-2 bg-card rounded border border-border">
